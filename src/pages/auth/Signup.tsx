...
const Signup = () => {
    ...
    return (
        <div className='flex min-h-90 flex-1 flex-col justify-center px-6 lg:px-8 '>
            <ToastContainer />
            ...
            <div className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm border-2 shadow-md p-5 mg-10'>
                <Form {...form}>
